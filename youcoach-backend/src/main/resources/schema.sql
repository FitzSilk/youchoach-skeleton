...
insert into secured_users (username, password, role)
values ('coachee1@school.org', '$2a$10$zM3YP185kIzV/jOMUNFy8ec5q2/Q42Rp1wCvoo.GIY1oG.gD.rldG', 'COACHEE');
insert into secured_users (username, password, role)
values ('coachee2@school.org', '$2a$10$zM3YP185kIzV/jOMUNFy8ec5q2/Q42Rp1wCvoo.GIY1oG.gD.rldG', 'COACHEE');
insert into secured_users (username, password, role)
values ('coach1@school.org', '$2a$10$zM3YP185kIzV/jOMUNFy8ec5q2/Q42Rp1wCvoo.GIY1oG.gD.rldG', 'COACH');
insert into secured_users (username, password, role)
values ('coach2@school.org', '$2a$10$zM3YP185kIzV/jOMUNFy8ec5q2/Q42Rp1wCvoo.GIY1oG.gD.rldG', 'COACH');
insert into secured_users (username, password, role)
values ('admin1@school.org', '$2a$10$zM3YP185kIzV/jOMUNFy8ec5q2/Q42Rp1wCvoo.GIY1oG.gD.rldG', 'ADMIN');
insert into secured_users (username, password, role)
values ('admin2@school.org', '$2a$10$zM3YP185kIzV/jOMUNFy8ec5q2/Q42Rp1wCvoo.GIY1oG.gD.rldG', 'ADMIN');
